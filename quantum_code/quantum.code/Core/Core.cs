...
namespace Quantum {
  ...
  public unsafe partial class Frame : Core.FrameBase {
    ...
    /// <summary>
    /// All root systems without their hierarchy.
    /// </summary>
    public SystemBase[] SystemsRoots { get { return _systemsRoots; } }
...
namespace Quantum {
  ...
  public partial class QuantumGameFlags {
    ...
    /// <summary>
    /// Enable this flag to keep calling <see cref="SystemBase.OnEnabled(Frame)"/> for all systems including
    /// the system that are marked <see cref="SystemBase.StartEnabled"/> as <see langword="false"/> by their parents.
    /// </summary>
    ...
    void InitSystems(DeterministicFrame df) {
      ...
      try {
        ...
        for (Int32 i = 0; i < _systemsAll.Length; ++i) {
          ...
          var startEnabled = _systemsAll[i].StartEnabledInHierarchy;
          if ((GameFlags & QuantumGameFlags.UseLegacySystemStartEnabledMode) == QuantumGameFlags.UseLegacySystemStartEnabledMode) {
            // Call System.OnEnabled() also for systems that are children of disabled systems.
            startEnabled = _systemsAll[i].StartEnabled;
          }
...
namespace Quantum {
  public partial class QuantumGame {
    ...
    void StopRecording() {
      // To not break projects only remove recording object here instead of deleting their data buffers.
      // It could be that the InputProvider is used after the game has been destroyed. 
      // Setting to null here will let GC handle it. 
      RecordedInputs = null;
...
namespace Quantum {
  public abstract partial class SystemBase {
    ...
    public Boolean StartEnabledInHierarchy {
      get {
        var node = this;
        while (node != null) {
          if (node.StartEnabled == false) {
            return false;
          }
          node = node.ParentSystem;
        }
        return true;
      }
    }
