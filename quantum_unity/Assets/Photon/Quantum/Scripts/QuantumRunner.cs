...
public sealed class QuantumRunner : MonoBehaviour, IDisposable {
  ...
  public struct StartParameters {
    ...
    /// </summary>
    [Obsolete("Init GameFlags field with QuantumGameFlags.DisableSharedChecksumSerializer instead")]
    public bool DisableInterpolatableStates {
      get => (GameFlags & QuantumGameFlags.DisableInterpolatableStates) != 0;
      set {
        if (value) {
    ...
    /// <summary>
    /// Additional game flags that can be set to customize QuantumGame behaviour. See <see cref="QuantumGameFlags"/> for
    /// more details.
    /// </summary>
  ...
  public static QuantumRunner StartGame(String clientId, StartParameters param) {
    ...
    args.DisableInterpolatableStates = (gameFlags & QuantumGameFlags.DisableInterpolatableStates) != 0;
