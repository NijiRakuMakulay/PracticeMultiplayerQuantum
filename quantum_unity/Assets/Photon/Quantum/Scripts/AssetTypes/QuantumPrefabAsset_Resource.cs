...
public partial class QuantumPrefabAsset_Resource : QuantumPrefabAsset {
  ...
  // There is no general way to unload a prefab with Resources API. Leaving this method as partial in
  // case you want to implement a custom way to unload prefabs.
  partial void UnloadPrefab(GameObject asset);
}
