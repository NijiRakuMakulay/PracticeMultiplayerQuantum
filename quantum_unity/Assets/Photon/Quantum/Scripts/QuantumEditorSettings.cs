...
public class QuantumEditorSettings : ScriptableObject {
  ...
  [Tooltip("Disabling the option will fix the baking of 3D rotated box colliders. The defensive opt-in is used to not break projects.")]
  public bool UseLegacyBox3DRotationBaking = true;
